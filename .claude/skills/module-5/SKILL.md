...
4. Explicitly connect this to the capstone: "Hold onto this list! In Module 7, you'll be creating a full automation plan, and some of your best ideas might involve MCP servers."
...
Then update the progress checklist in CLAUDE.md by changing Module 5 from `[ ]` to `[x]`:
```
- [x] Module 5: MCP Servers
```
