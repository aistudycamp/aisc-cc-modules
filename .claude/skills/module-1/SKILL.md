...
Claude Code isn't text-only — you can paste images right into the terminal. Drag and drop a screenshot into the Claude Code window, or use your native paste shortcut (⌘+V on Mac, Ctrl+V on Windows/Linux) after copying an image. Claude can actually see the picture and reason about it.
...
| **Commands & slash commands** | Navigate Claude Code like a pro with `/help`, `/clear`, `/compact`, and your own skills. |
...
You're no longer just using Claude Code — you're driving it. Onward to Module 2!
