---
name: module-4
description: "Module 4: Hooks — Understand automatic behaviors triggered by events in Claude Code"
---
...
Welcome the student to Module 4:

> "Welcome to Module 4! You've already learned how to shape Claude's behavior with CLAUDE.md, create reusable skills, and install plugins. Now we're going to learn about something that takes things to the next level: Hooks -- automatic behaviors that run without you having to do anything. Let's dig in!"
...
1. **Update the progress checklist** in CLAUDE.md by changing `- [ ] Module 4: Hooks` to `- [x] Module 4: Hooks`

2. **Direct them to the next module:**
   > "You're over halfway through the course! Module 5 is about MCP Servers -- how Claude connects to external services like databases, APIs, and other tools. Type `/module-5` when you're ready to keep going!"
